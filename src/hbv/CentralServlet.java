	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      response.sendRedirect("login.html");
...

		{
			...
			session.setAttribute("heure1", heure1);
    ...
    //Verification si la date entre n'est pas dans le passe
        ...
        stmt4.close();
          ...
          stmt5.close();
            ...
            out.println("<script>alert('Ihr Termin könnte derzeit nicht gespeichert werden. Bitte wiederholen Sie nochmal');" +" window.location.href='central.html?username=" + username +"</script>");
